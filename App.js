...
async function showMovies(pageNumber = 1, sort_by = "desc") {
  ...
  const options = {
    ...
    headers: {
      ...
      Authorization:
        "Bearer eyJhbGciOiJIUzI1NiJ9.eyJhdWQiOiJhMjc0NDBmZWRjYzZjNTQ0NjQ0MzE2ZjllNzNmNTM5YiIsInN1YiI6IjY0ZGI1NTU0NTllOGE5MDExYzhhOWZhOSIsInNjb3BlcyI6WyJhcGlfcmVhZCJdLCJ2ZXJzaW9uIjoxfQ.8x9LNTGHBr5GfQJ6jCHPCVk4F4TNYlY1-jGAPRpXq1Q",
    },
  };
  let response;

  response = await fetch(
    `https://api.themoviedb.org/3/movie/popular?language=en-US&page=${pageNumber}&sort_by=${
